        ...
        if (this.bug.body.blocked.down && this.bug.body.velocity.x === 0 && this.canCollect == true) {
            if (this.score == 25) {
                ...
                this.time.delayedCall(4000, () => {
                    this.scene.start('CheckScore', { bugColor: this.bugColor, cumulativeScore: this.score + this.runningTotal, levels: this.levels + 1, level: 7 }); // start next level after delay
                });
