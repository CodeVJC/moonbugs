...
class Level2 extends Phaser.Scene {
    ...
    create() {
        ...
        this.totalText = this.add.text(750, 550, this.runningTotal, { fontFamily: 'Concert One', fontSize: '24px', fill: '#00ffff' }); 
    ...
    collecth3(bug, h3) {
        ...
        this.totalText.setText(this.runningTotal + this.score);
